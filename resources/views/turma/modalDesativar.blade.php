<form method="get" id="formDesativarTurma">
    <input type="hidden" name="_token" value="{{csrf_token()}}">
    <input type="hidden" id="co_seq_turma" name="co_seq_turma"
           value="{{ $dados['co_seq_turma']}}">
    <div class="row">
...
<script src="{{asset('assets/js/turma/submitDesativar.js')}}"></script>
